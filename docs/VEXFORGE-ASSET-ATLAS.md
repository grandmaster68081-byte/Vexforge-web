...
| `mobile/assets/images/home-reference-scene.png` | Home | Escena vertical oficial Home/Nexus; arte ambiental, no captura de UI |
...
`home-reference-scene.png` es la escena visual oficial del Home y se monta como
arte ambiental de la composición nativa. No contiene controles funcionales ni
autoriza hotspots transparentes: datos, estados, controles y rutas siguen
siendo programáticos y vivos.
