...
export const VISUAL_TOKENS = {
  ...
  battlefield: {
    ...
    typography: {
      ...
      liveHudLabel: { fontSize: 8, lineHeight: 10, fontWeight: '900', letterSpacing: 0.6 },
      liveHudValue: { fontSize: 8, lineHeight: 10, fontWeight: '800' },
      ...
      roleText: { fontSize: 8, lineHeight: 10, fontWeight: '900', letterSpacing: 0.5 },
      fallenText: { fontSize: 6, fontWeight: '900', letterSpacing: 0.4 },
      artMissing: { fontSize: 6, fontWeight: '900' },
      unitName: { fontSize: 11, lineHeight: 14, fontWeight: '800', minHeight: 28 },
      unitFaction: { fontSize: 8, lineHeight: 10, fontWeight: '900', letterSpacing: 0.35 },
      hpText: { fontSize: 8, lineHeight: 10, fontWeight: '700' },
      keyword: { fontSize: 5.5, fontWeight: '900', letterSpacing: 0.2 },
      reserveTitle: { fontSize: 8, fontWeight: '900', letterSpacing: 0.6 },
      emptyReserve: { fontSize: 8, fontWeight: '900' },
      laneLabel: { fontSize: 10, fontWeight: '900', letterSpacing: 0.9 },
      laneCopy: { fontSize: 10, lineHeight: 13 },
