...
export const VISUAL_TOKENS = {
  ...
  battlefield: {
    ...
    typography: {
      eyebrow: { fontSize: 8, letterSpacing: 1.2 },
      title: { fontSize: 18, letterSpacing: 0.4, marginTop: 3 },
      turnValue: { fontSize: 13 },
      turnLabel: { fontSize: 7, letterSpacing: 0.6, marginTop: 2 },
      identityKicker: { fontSize: 8, letterSpacing: 0.9 },
      identityName: { fontSize: 12, marginTop: 2 },
      identityStatus: { fontSize: 8, letterSpacing: 0.7 },
      roleText: { fontSize: 7, letterSpacing: 0.45 },
      fallenText: { fontSize: 6, letterSpacing: 0.4 },
      artMissing: { fontSize: 6 },
      unitName: { fontSize: 10, lineHeight: 13, minHeight: 26 },
      unitFaction: { fontSize: 7, letterSpacing: 0.3 },
      hpText: { fontSize: 7 },
      keyword: { fontSize: 5.5, letterSpacing: 0.2 },
      reserveTitle: { fontSize: 7, letterSpacing: 0.5 },
      emptyReserve: { fontSize: 7 },
      laneLabel: { fontSize: 9, letterSpacing: 0.8 },
      laneCopy: { fontSize: 9 },
      damageLabel: { fontSize: 11, marginTop: 2 },
      outcome: { fontSize: 9, letterSpacing: 0.7, paddingVertical: 4 },
    },
    controls: {
      borderWidth: 1,
