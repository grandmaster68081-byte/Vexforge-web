...
const styles = StyleSheet.create({
  ...
  modalEyebrow: { fontFamily: typography.bodyBold, fontSize: VISUAL_TOKENS.profileModal.content.eyebrow.fontSize, letterSpacing: VISUAL_TOKENS.profileModal.content.eyebrow.letterSpacing },
  modalTitle: { fontFamily: typography.display, fontSize: VISUAL_TOKENS.profileModal.content.title.fontSize, marginTop: VISUAL_TOKENS.profileModal.content.title.marginTop },
  modalClose: {
  ...
  modalCopy: { gap: VISUAL_TOKENS.profileModal.content.copyGap },
  modalBody: { fontFamily: typography.display, fontSize: VISUAL_TOKENS.profileModal.content.body.fontSize },
  modalMuted: { fontFamily: typography.body, fontSize: VISUAL_TOKENS.profileModal.content.muted.fontSize, lineHeight: VISUAL_TOKENS.profileModal.content.muted.lineHeight },
  modalList: { maxHeight: VISUAL_TOKENS.profileModal.content.listMaxHeight },
  modalRow: { minHeight: VISUAL_TOKENS.profileModal.content.row.minHeight, borderWidth: VISUAL_TOKENS.profileModal.content.row.borderWidth, borderRadius: VISUAL_TOKENS.profileModal.content.row.radius, padding: VISUAL_TOKENS.profileModal.content.row.padding, marginBottom: VISUAL_TOKENS.profileModal.content.row.marginBottom, flexDirection: 'row', alignItems: 'center', gap: VISUAL_TOKENS.profileModal.content.row.gap },
  modalRowCopy: { flex: 1 },
  modalRowTitle: { fontFamily: typography.bodyBold, fontSize: VISUAL_TOKENS.profileModal.content.rowTitle.fontSize },
  modalPoints: { fontFamily: typography.bodyBold, fontSize: VISUAL_TOKENS.profileModal.content.points.fontSize },
  modalRank: { width: VISUAL_TOKENS.profileModal.content.rank.width, fontFamily: typography.display, fontSize: VISUAL_TOKENS.profileModal.content.rank.fontSize },
  signOutButton: { minHeight: VISUAL_TOKENS.profileModal.content.signOut.minHeight, borderWidth: VISUAL_TOKENS.profileModal.content.signOut.borderWidth, borderRadius: VISUAL_TOKENS.profileModal.content.signOut.radius, paddingHorizontal: VISUAL_TOKENS.profileModal.content.signOut.paddingHorizontal, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: VISUAL_TOKENS.profileModal.content.signOut.gap, marginTop: VISUAL_TOKENS.profileModal.content.signOut.marginTop },
  signOutText: { fontFamily: typography.bodyBold, fontSize: VISUAL_TOKENS.profileModal.content.signOutText.fontSize, letterSpacing: VISUAL_TOKENS.profileModal.content.signOutText.letterSpacing },
});