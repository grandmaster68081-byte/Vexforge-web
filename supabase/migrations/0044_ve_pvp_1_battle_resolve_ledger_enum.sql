-- VE-PVP-1-BATTLE-RESOLVE-LEDGER-ENUM
-- Causa raiz: vexforge_battle_resolve llamaba wallet_tx(..., 'in', ...) y
-- safe_wallet_transaction castea p_direction a ledger_entry_type, enum que no
-- contiene 'in'. La transaccion abortaba (22P02) en la fase 16 y ninguna
-- batalla PVP podia completarse. Se sustituye por el valor canonico
-- 'combat_reward' (acredita, igual que cualquier direccion distinta de debit).
-- El resto del cuerpo del RPC queda intacto.
