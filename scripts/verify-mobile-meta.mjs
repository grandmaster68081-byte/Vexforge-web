...
const assertions = [
  ...
  ['meta catalog preserves missing cosmetic signals', source['mobile/app/meta.tsx'].includes('RAREZA NO REPORTADA') && source['mobile/app/meta.tsx'].includes('DESCRIPCIÓN NO REPORTADA') && source['mobile/app/meta.tsx'].includes('TIPO NO REPORTADO') && !source['mobile/app/meta.tsx'].includes("'Catálogo oficial'") && !source['mobile/app/meta.tsx'].includes("'Sin descripción adicional.'")],
  ['meta relics preserve missing effect signals', source['mobile/app/meta.tsx'].includes('EFECTO NO REPORTADO') && !source['mobile/app/meta.tsx'].includes("'Efecto de Forja'")],
  ['meta NFT preserves missing contract and queue signals', source['mobile/app/meta.tsx'].includes('CONTRATO NO REPORTADO EN LA FUENTE OFICIAL') && source['mobile/app/meta.tsx'].includes('ESTADO NO REPORTADO') && source['mobile/app/meta.tsx'].includes('CARTA NO REPORTADA') && !source['mobile/app/meta.tsx'].includes("'Contrato en preparación'")],
