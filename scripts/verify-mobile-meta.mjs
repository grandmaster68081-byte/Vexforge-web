...
const assertions = [
  ...
  ['explicit loading, error, empty and refresh states', source['mobile/app/meta.tsx'].includes('Sincronizando sistemas') && source['mobile/app/meta.tsx'].includes('meta-retry') && source['mobile/app/meta.tsx'].includes('RefreshControl') && source['mobile/app/meta.tsx'].includes('Colección vacía')],
