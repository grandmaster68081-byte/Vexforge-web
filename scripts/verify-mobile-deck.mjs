...
const assertions = [
  ...
  ['deck uses the canonical reference canvas', contents.screen.includes('getCanonicalFrameMetrics') && contents.screen.includes('marginTop: insets.top') && contents.screen.includes('resizeMode="stretch"')],
