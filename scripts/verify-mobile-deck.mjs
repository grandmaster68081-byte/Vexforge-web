...
const assertions = [
  ...
  ['deck summary stays inside the authored detail frame', contents.screen.includes('testID="deck-summary-overlay"') && contents.screen.includes('top: canvasHeight * 0.735') && contents.screen.includes('deckSummaryMask')],
