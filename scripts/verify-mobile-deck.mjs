...
const assertions = [
  ...
  ['deck controls align to the forge scene regions', contents.screen.includes('top: canvasHeight * 0.405') && contents.screen.includes('top: canvasHeight * 0.605') && contents.screen.includes('top: canvasHeight * VISUAL_TOKENS.deck.actionRail.topRatio')],
  ...
  ['deck chamber presentation consumes shared visual tokens', contents.screen.includes("from '@/constants/experience'") && contents.screen.includes('VISUAL_TOKENS.deck.sceneHeader') && contents.screen.includes('VISUAL_TOKENS.deck.refresh') && contents.screen.includes('VISUAL_TOKENS.deck.actionRail') && contents.screen.includes('VISUAL_TOKENS.deck.searchDock') && contents.screen.includes('VISUAL_TOKENS.deck.coreAction') && contents.screen.includes('VISUAL_TOKENS.deck.utilityRail') && contents.screen.includes('VISUAL_TOKENS.deck.utility')],
