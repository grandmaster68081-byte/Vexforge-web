...
const assertions = [
  ...
  ['deck summary stays inside the forge scene region', contents.screen.includes('testID="deck-summary-overlay"') && contents.screen.includes('top: canvasHeight * 0.715') && contents.screen.includes('deckSummaryActions')],
  ['deck controls align to the forge scene regions', contents.screen.includes('top: canvasHeight * 0.405') && contents.screen.includes('top: canvasHeight * 0.59') && contents.screen.includes('top: canvasHeight * 0.715')],
