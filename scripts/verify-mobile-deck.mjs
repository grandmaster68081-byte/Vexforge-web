...
const assertions = [
  ...
  ['deck uses the canonical reference canvas', contents.screen.includes('getCanonicalFrameMetrics') && contents.screen.includes('marginTop: insets.top') && contents.screen.includes('resizeMode="cover"')],
  ['deck controls align to the reference flows', contents.screen.includes('top: canvasHeight * 0.374') && contents.screen.includes('top: canvasHeight * 0.445')],
