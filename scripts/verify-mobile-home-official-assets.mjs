...
const assertions = [
  ...
  ['Home consumes the approved visual reference as its authored scene', screen.includes('CANONICAL_BACKGROUNDS.home') && screen.includes('homeSceneSource') && screen.includes('styles.heroSceneReference')],
