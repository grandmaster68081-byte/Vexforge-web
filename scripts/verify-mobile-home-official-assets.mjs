...
const assertions = [
  ...
  ['Home never turns missing numeric signals into zero', screen.includes("if (typeof value !== 'number' || !Number.isFinite(value)) return '—';") && screen.includes('const progression =') && screen.includes('PROGRESIÓN EN ESPERA') && screen.includes('{progression ? <ProgressRail') && !screen.includes('value ?? 0')],
