...
const assertions = [
  ...
  ['profile uses the shared canonical reference canvas contract', contents.screen.includes('getCanonicalFrameMetrics') && contents.screen.includes('width: frameWidth') && contents.screen.includes('height: canvasHeight') && contents.screen.includes('marginTop: insets.top') && contents.screen.includes('resizeMode="cover"') && !contents.screen.includes('resizeMode="stretch"')],
