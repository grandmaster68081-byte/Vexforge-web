...
const assertions = [
  ...
  ['profile uses the measured canonical reference canvas contract', contents.screen.includes('useMeasuredCanonicalFrame') && contents.screen.includes('onLayout={onLayout}') && contents.screen.includes('width: frameWidth') && contents.screen.includes('height: canvasHeight') && contents.screen.includes('marginTop: insets.top') && contents.screen.includes('resizeMode="stretch"')],
  ['profile reference is 1080x2340 RGB', referenceWidth === 1080 && referenceHeight === 2340 && referenceColorType === 2],
  ['profile preserves measured frame scaling', contents.screen.includes('frameScale') && contents.screen.includes('insets.top') && contents.screen.includes('insets.bottom')],
