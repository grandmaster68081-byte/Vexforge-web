...
const assertions = [
  ...
  ['battle keeps AI training behind the explicit practice tile', contents.screen.includes('simulateQuickAIBattle') && contents.screen.includes('reference-quick-battle') && contents.screen.includes('battle-ai-fallback') && contents.ai.includes('client_ai_v1') && contents.screen.includes('No hay un rival real disponible ahora')],
