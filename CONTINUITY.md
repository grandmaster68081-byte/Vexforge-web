...
- Estado honesto: `IMPLEMENTED_UNVERIFIED`; falta publicar este bloque en `main`, ejecutar el workflow oficial APK, comprobar el release correlativo y realizar QA visual/táctil humana en dispositivo. Siguiente bloque: revisar esa evidencia sin rediseñar la escena consolidada.
